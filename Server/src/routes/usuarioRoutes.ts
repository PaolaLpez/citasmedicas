...
class UsuarioRoutes {
  ...
  config(): void {
    ...
    this.router.get('/:id_usuario', usuarioControllers.getOneUsuario);
    this.router.get('/paciente/id/:id_usuario', usuarioControllers.getPacienteId); // Nueva ruta para obtener el ID del paciente
    this.router.get('/paciente/nombre/:id_usuario', usuarioControllers.getPacienteNombre); // Nueva ruta para obtener el nombre del paciente
  }
}
