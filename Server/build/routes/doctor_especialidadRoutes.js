...
class Doctor_EspecialidadRoutes {
    ...
    config() {
        ...
        this.router.delete('/:id_doctor/:id_especialidad', doctor_especialidadControllers_1.doctor_especialidadControllers.delete);
        this.router.put('/:id_doctor/:id_especialidad', doctor_especialidadControllers_1.doctor_especialidadControllers.update);
        this.router.get('/:id_doctor/:id_especialidad', doctor_especialidadControllers_1.doctor_especialidadControllers.getOne);
    }
}
